      ...
      today.getMonth() + 1
        ...
        if (existingActiveQueue) {
            ...
            return res.status(409).json({
                message: "Anda sudah memiliki antrian aktif hari ini. Silakan selesaikan atau batalkan antrian tersebut sebelum mengambil yang baru.",
            });
        }
        ...
        await OtpCode.update({ is_used: true, is_verified: false, expires_at: new Date() }, {
            where: {
        ...
        if (myQueue.status === "pending_otp") {
            return res.status(200).json({
                ...
                current_calling_number: currentCalling ?
                    currentCalling.full_queue_number : "Belum ada",
                queues_in_front: "N/A",
