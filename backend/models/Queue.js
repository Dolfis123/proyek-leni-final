...
module.exports = (sequelize) => {
    const Queue = sequelize.define('Queue', {
        ...
        full_queue_number: {
            ...
            allowNull: false,
            unique: 'compositeIndex', // Ini akan menjadi bagian dari UNIQUE composite key
        },
        customer_name: {
        ...
        status: {
            type: DataTypes.ENUM('pending_otp', 'waiting', 'calling', 'completed', 'missed', 'recalled', 'on_hold', 'expired'),
            allowNull: false,
